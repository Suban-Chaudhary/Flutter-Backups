...
class AppConstants {
  static const String BASE_URL = 'https://dealnepal.com.np';
  static const String CATEGORY_URI = '/api/v1/categories';
  static const String BANNER_URI = '/api/v1/banners';
  static const String POPULAR_PRODUCT_URI = '/api/v1/products/st';
  ...
  static const String TRACK_URI = '/api/v1/customer/order/trackorder_id=';
  ...
  static const String REMOVE_ADDRESS_URI =
      '/api/v1/customer/address/deleteaddress_id=';
  ...
  static const String COUPON_APPLY_URI = '/api/v1/coupon/applycode=';
  ...
  static const String LAST_LOCATION_URI =
      '/api/v1/delivery-man/last-locationorder_id=';
